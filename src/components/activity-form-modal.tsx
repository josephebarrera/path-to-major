...
export function ActivityFormModal({
  ...
  return createPortal(
    <div className="p2m-app fixed inset-0 z-50 flex items-center justify-center bg-black/20 p-4">
      <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto border border-border bg-background p-6">
        ...
        <form onSubmit={submit} className="mt-5 space-y-3">
          <Field label="Activity name" required>
            <input
              ...
              className={`w-full rounded-xl border px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-foreground ${
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="Category">
              <select
                ...
                className="w-full rounded-xl border border-border px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-foreground"
              >
          ...
          <label className="flex items-start gap-2.5 border border-border px-3 py-2.5 text-sm">
            <input
              type="checkbox"
          ...
          <button
            type="submit"
            disabled={saving}
            className="mt-2 flex w-full items-center justify-center gap-2 rounded-full bg-foreground py-2.5 text-sm font-medium text-background disabled:opacity-50"
          >
