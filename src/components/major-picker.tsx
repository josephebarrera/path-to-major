  ...
  return (
    <div>
      <input
        ...
        className="w-full border border-border bg-white/10 px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-ring"
      />
        ...
        {filtered.map((major) => {
          ...
          return (
            <button
              ...
              disabled={disabled}
              className={`px-3 py-1.5 text-xs font-medium transition disabled:cursor-not-allowed disabled:opacity-40 ${
                isSelected
